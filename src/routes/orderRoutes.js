...
const { createOrder, getOrder, listOrders, getLiveOrderStats, updateOrderStatus, assignDeliverer, deleteOrder } = require('../controllers/orderController');
...
router.get('/live-stats', getLiveOrderStats);
...
router.post('/:id/assign', jwtAuth, authorize('VENDOR', 'ADMIN', 'DELIVERER'), validateObjectId(), validateRequest(assignDelivererSchema), assignDeliverer);
